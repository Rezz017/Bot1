...
//=====LIST HARGA SEWA BOT SETING DI SETINGS.JSON===//
minggu = settings.minggu
bulan = settings.bulan
manen = settings.manen
/***==FAKE==***/
r = '🔖'
multi = true
nopref = false
...
try {
		...
		const katalog = (teks) => {
             res = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_©REZZ GANZ*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             denz.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = denz.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/IkG3GORp9rL7mCKKU3Huee', "groupName": `${NamaBot}`, "footerText": "*_©BOT*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
reply(String(e))
        ...
        if (budy.includes("https://chat.whatsapp.com/")) {
        	...
        	if (!mek.key.fromMe){
				...
				denz.updatePresence(from, Presence.composing)
				var kic = `${sender.split("@")[0]}@s.whatsapp.net`
				reply('Link Yt terdeteksi, Auto kick!')
			    denz.groupRemove(from, [kic]).catch((e) => { sticNotAdmin(from) })
			}
			}
...
if(isButton == 'igm'){
reply('http://instagram.com/ini_rezz19')
}
if(isButton == 'ytm'){
reply('http://youtube.com/REZZBOT')
}
...
"thumbnail": pporigi,
       ...
       menu = `┌───「 \`\`\`${NamaBot}\`\`\` 」
│
├ ${r} _Creator : @${dtod.split('@')[0]}_
├ ${r} _Battery : ${baterai.battery}_
├ ${r} _Mode : ${publik ? 'Public' : 'Self'}_
├ ${r} _Total Hit : ${cmhit.length}_
├ ${r} _Prefix : ${multi ? 'Multi Prefix' : 'No Prefix'}_
│
├───「 \`\`\`INFO BOT\`\`\` 」
│
├ ${r} _Nama Bot : ${NamaBot}_
├ ${r} _Nama Owner : ${NamaOwner}_
├ ${r} _Nomor Owner : @${otod.split('@')[0]}_
├ ${r} _Auto Composing : ${settings.autocomposing}_
├ ${r} _Auto Recording : ${settings.autorecording}_
│
├───「 \`\`\`INFO USER\`\`\` 」
│
├ ${r} _Status : ${isOwner ? 'Owner' : 'User'}_
├ ${r} _Nama : ${pushname}_
├ ${r} _Bio : ${stst}_
├ ${r} _Nomor : @${stod.split('@')[0]}_
├ ${r} _Info Nomor : ${num.data.country_code} - ${num.data.carrier.type} - ${num.data.carrier.name}_
│
└───「 \`\`\`${NamaBot}\`\`\` 」`
sendButLocation(from, `${menu}`, "*_©REZZ GANZ*", {jpegThumbnail:ofrply,name:""}, [{buttonId:`command`,buttonText:{displayText:'LIST MENU'},type:1},{buttonId:`owner`,buttonText:{displayText:'DEVELOPER'},type:1},{buttonId:`gada`,buttonText:{displayText:'OKE'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
break
  case 'via':
  case 'pembayaran':
...
*│*⬡ *GOPAY    : ${gopay}*
*└───────────────────*
Scan QR di atas bila pengguna Dana Gopay Ovo`
...
stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
       nama = '🌹 ALL MENU BOT 🌹'
       ownerJid = "6281313726400@s.whatsapp.net"
				stst = stst.status == 401 ? '' : stst.status
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
menunya = `╭─❒ 「 Bot Info 」 ❒
...
stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
       nama = '🐳 SEWA BOT BANG?KAK?🐳'
       ownerJid = "6281313726400@s.whatsapp.net"
				stst = stst.status == 401 ? '' : stst.status
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
menunya = `Hai Kak ${pushname}, ${tampilUcapan} 
Mau Sewa Bot??
List sewa Bot
...
Antilink Grup, Welcome,Kick Otomatis,Anti Virtex/Slayer,Bug Gc,Anti Toxic,Stiker,Wibu,Adventure,Tebak Kata,Tebak Anime,18+,dan masih banyak lagi fitur lainnya

SISTEM: MASUKIN BOT-TF-DONE

BISA DI TES DULU BOTNYA

📌 𝗠𝗜𝗡𝗔𝗧? wa.me//${NomorOwner}`
if(menuall == false){
   //Masih langka
function _0x21f8(){var _0x5b970c=['5573144JYwLrC','528103swWGih','image/jpeg','HZ7GZtD+MZleBjG1flbeTuZkDThPV6frfERXi4zTBvs=','readFileSync','69880vdqygB','431675fOwedq','3264wpwOzQ','3ucdrq0UyCuNG5YcUD9aKX4qkuvcip+OonjhACusy5Q=','988644bxSaXV','19894ILewVQ','2QmpxNq','66214','9999999','1341KlrShJ','2506689kwMmco','./denz.jpg'];_0x21f8=function(){return _0x5b970c;};return _0x21f8();}function _0x4cac(_0x23a824,_0x283a6f){var _0x21f8ef=_0x21f8();return _0x4cac=function(_0x4cacde,_0x3311de){_0x4cacde=_0x4cacde-0xc7;var _0x13ea77=_0x21f8ef[_0x4cacde];return _0x13ea77;},_0x4cac(_0x23a824,_0x283a6f);}var _0xcdc6be=_0x4cac;(function(_0x130db2,_0x4b9859){var _0x3cd68e=_0x4cac,_0x5ee5d3=_0x130db2();while(!![]){try{var _0x2ac92a=-parseInt(_0x3cd68e(0xce))/0x1*(-parseInt(_0x3cd68e(0xc7))/0x2)+parseInt(_0x3cd68e(0xcb))/0x3+-parseInt(_0x3cd68e(0xd6))/0x4+-parseInt(_0x3cd68e(0xd3))/0x5+parseInt(_0x3cd68e(0xd4))/0x6*(parseInt(_0x3cd68e(0xd7))/0x7)+-parseInt(_0x3cd68e(0xcd))/0x8+parseInt(_0x3cd68e(0xca))/0x9*(-parseInt(_0x3cd68e(0xd2))/0xa);if(_0x2ac92a===_0x4b9859)break;else _0x5ee5d3['push'](_0x5ee5d3['shift']());}catch(_0x5691cb){_0x5ee5d3['push'](_0x5ee5d3['shift']());}}}(_0x21f8,0xccadb),anu=denz['prepareMessageFromContent'](from,{'productMessage':{'product':{'productImage':{'url':'https://mmg.whatsapp.net/d/f/Aj5vJ5V6aD4eIRoj-9Q26GBNXq_AeVscAB9ENRvLEPmO.enc','mimetype':_0xcdc6be(0xcf),'fileSha256':_0xcdc6be(0xd0),'fileLength':_0xcdc6be(0xc8),'height':0x2d0,'width':0x2d0,'mediaKey':_0xcdc6be(0xd5),'fileEncSha256':'ifE4O/SNQnPWVe8ya6QZlshnaqIDLcvWFJT4RQ4Bbvk=','jpegThumbnail':fs[_0xcdc6be(0xd1)](_0xcdc6be(0xcc))},'productId':_0xcdc6be(0xc9),'title':''+nama,'description':''+menunya,'productImageCount':0x1},'businessOwnerJid':''+ownerJid,'contextInfo':{'forwardingScore':0x270f,'isForwarded':!![]}}},{'quoted':ftrol,'contextInfo':{'mentionedJid':[dtod,otod,stod]}}),denz['relayWAMessage'](anu));
                  } else if(menuall = true){
...
client.browserDescription = ['NUMPANG BOT','Desktop','3.0']
...
const btnasu = {
    contentText: `${anu}`,
    footerText: `MODE ANTILINK BY ${NamaBot}`,
    buttons: punten,
    headerType: 1
}
await denz.sendMessage(from, btnasu, MessageType.buttonsMessage, {quoted: ftrol})
			...
			if (!isBotGroupAdmins) return sticNotAdmin(from)
					if (args[0] === 'on') {
						if (isAntiyt) return reply('Sudah Aktif Kak')
						antiyt.push(from)
						fs.writeFileSync('./database/antiyt.json', JSON.stringify(antiyt))
						reply('Sukses mengaktifkan fitur antilink Youtube')
						denz.sendMessage(from, `ALLERT!!! Group ini sudah di pasang anti link You Tube\nJika Kamu Melanggar Maka Akan Saya Tendang Terima Kasih`, text)
					} else if (args[0] === 'off') {
						if (!isAntiyt) return reply('Sudah Mati Kak')
						var ini = antiyt.indexOf(from)
						antiyt.splice(ini, 1)
						fs.writeFileSync('./database/antiyt.json', JSON.stringify(antiyt))
						reply('Sukses menonaktifkan fitur antilink Youtube')
					} else if (!c){
 anu =`Silahkan pilih salah satu\n\non: untuk mengaktifkan\noff: untuk menonaktifkan`
punten = [{buttonId: 'antilinkyt off', buttonText: {displayText: 'OFF✖️'}, type: 1},{buttonId: 'antilinkyt on', buttonText: {displayText: 'ON✔️'}, type: 1}]
const btnasu = {
    contentText: `${anu}`,
    footerText: `MODE ANTILINK YT BY ${NamaBot}`,
    buttons: punten,
    headerType: 1
}
await denz.sendMessage(from, btnasu, MessageType.buttonsMessage, {quoted: ftrol})
...
Giliran = @${tty.player1.split('@')[0]}`
 denz.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     denz.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer Bitch Boot",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://wa.me//6281313726400"}}})
	}
    }
    }
    }
